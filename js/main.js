...
//           }
   ...
   getContacts: function() {
      ...
      $.ajax({
         url: serverAddress + "/getFriends"+"?sessionID="+sessionID,
         type: 'GET',
         data: JSON.stringify({"sessionID": sessionID}),
         dataType: 'json',
   ...
   getTimeline: function() {
      ...
      $.ajax({
      url: serverAddress + "/getTimeline"+"?sessionID="+sessionID,
      type: 'GET',
      data: JSON.stringify({"sessionID": sessionID}),
      dataType: 'json',
...
function isAlreadyAuthenticated(){
  ...
  {
   $.ajax({
      url: serverAddress + "/isAlreadyAuthenticated",
      type: 'POST',
      data: JSON.stringify({"sessionID": sessionID}),
      dataType: 'json',
      ...
      success: function (data) {
        console.log('isAlreadyAuthenticated:' + data);
          ...
          if(data == true){
            ...
            $.ajax({
                url: serverAddress + "/authenticate",     //?sessionID="+sessionID,
                type: 'POST',
                data: JSON.stringify({"sessionID": sessionID}),
                dataType: 'json',
                //type: 'GET',
...
//                             });
        ...
        error: function (data) {
            if(!isAndroid) alert("Error: failed to load resource "+ serverAddress + ". Server not available. Aborting");
